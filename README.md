...
## 💡 關鍵結論 (Key Findings)
* **核心驅動因子**：經相關性分析與模型驗證，「社會支持」與「人均 GDP」是影響幸福指數的兩大關鍵因素，其中社會支持的重要性略高於 GDP。
* **預測準確度**：線性迴歸模型 R² 達到 0.843，證明所選變數能有效解釋全球國家幸福感的變異。
* **區域分群洞察**：透過 PCA 與 K-Means 分群，成功識別出全球國家發展程度的三大範疇（發展中奮鬥、生存挑戰、幸福繁榮），且呈現顯著的地理區域特性。
